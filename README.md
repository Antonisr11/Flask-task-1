...
Αφού αυθεντικοποιηθεί ο χρήστης (βλέπουμε ερώτημα 3) βρίσκουμε όλους τους φοιτητές με ηλικία μεγαλύτερη ή ίση των 30 χρονών. Ακολουθούμε την ίδια νοοτροπία με το ερώτημα 4 με την μόνη διαφορά πως αφού βρούμε την φετινή χρονολογία και τις αφαιρέσουμε 30, ψάχουμε για ημερομηνίες μικρότερες ή ίσες από αυτή. 
...
Αφού αυθεντικοποιηθεί ο χρήστης (βλέπουμε ερώτημα 3) ψάχνουμε για έναν μαθητή με αυτό το e-mail με την συνάρτηση find_one. Για να κάνουμε τον κώδικα πιο μικρό αλλά και για να αποφύγουμε περριτούς ελέγχους σε αυτό το ερώτημα το έχουμε υλοποιήσει με διαφορετικό τρόπο από τα προηγούμενα. 
